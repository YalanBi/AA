...
#*************************************************************** test part ***************************************************************#
#find expressed genes, median higher than threshould=5
findExpGene <- function(chr, threshould = 5){
  ...
  for(filename in genenames){
    ...
    if(length(exonID) > 0){
      ...
      if(median(unlist(rawexp[exonID, 17:164])) >= threshould){
...
expGene <- findExpGene(chr = 1, threshould = 5)
...
for(chr in 1:5){
  expGeneList[[chr]] <- findExpGene(chr, threshould = 5)
}
...
for(chr in 1:5){
  expGene <- findExpGene(chr, threshould = 5)
