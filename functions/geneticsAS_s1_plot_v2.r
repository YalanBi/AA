...
plotExpEnvSep <- function(filename, toTest, m, tuShowGAS, GASchr, ...){
  ...
  for(env in 1:4){
    ...
    if(env == 1){
      par(fig = c(0, 1, 13/12-0.25*env, 15/12-0.25*env), oma = c(5, 3, 5, 0.5), mar = c(0, 4, 0, 2))
    }else par(fig = c(0, 1, 13/12-0.25*env, 15/12-0.25*env), oma = c(5, 3, 5, 0.5), mar = c(0, 4, 0, 2), new = TRUE)
    ...
    par(fig = c(0, 1, 1-0.25*env, 13/12-0.25*env), oma = c(5, 3, 5, 0.5),  mar = c(0, 4, 0, 2), new = TRUE)
